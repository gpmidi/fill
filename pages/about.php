<?php
	...
	$template_settings['HR_TEMPLATE_TITLE'] = "About";
	$template_settings['HR_TEMPLATE_VARS'] = array('url' => '/about', 'uri' => 'about');
	$template_settings['HR_TEMPLATE_CONTENT'] = "<h3>About the team</h3> 
